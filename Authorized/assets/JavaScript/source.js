...
*/
    ...
    function handler333() {
        ...
        $('.navlistRight li:nth-child(3)').css('color', '#128b94');
        $('.navlistRight li:nth-child(3)').one("click", handler444);
    ...
    function handler444() {
        ...
        $('.navlistRight li:nth-child(3)').css('color', '#03253b');
        $('.navlistRight li:nth-child(3)').one("click", handler333);
    ...
    */
    ...
    $('.openAcc').click(function(){
        $('.AccB').slideToggle(500);
    });

    /* Rotate Sidenav arrow4 */
    function handler1800() {
        var arrow9 = $('#arrow9');
        TweenLite.to(arrow9, .2, {rotation: 180, transformOrigin:"50%"});
        $('.openAcc').one("click", handler1900);
    }

    function handler1900() {
        var arrow9 = $('#arrow9');
        TweenLite.to(arrow9, .2, {rotation: 0, transformOrigin:"50%"});
        $('.openAcc').one("click", handler1800);
    }
    ...
    $(".navlistRight li:nth-child(3)").click(function(){
